...
public class TimedSPARQLEvaluator {
	
	public static class TimeOutException extends Exception {
		
		private static final long serialVersionUID = 8779352554861585041L;
	...
	public TimedSPARQLEvaluator(Summary s, SPARQLQuery q, long totalTime) throws TimeOutException {
		this.summary = s;
		this.cutoffTime = totalTime;
		query = q;
	...
	public double evaluate() throws TimeOutException  {
	...
	private void evaluate(int atomIndex) throws TimeOutException {
	...
	protected void process() throws TimeOutException {
		...
		while (partition != null) {
			...
			if (partition.isTauUnifiable(tau)) {
				result += minimalSolutions(partition, tau) * queryFactor(partition, tau);
			}
	...
	class PartitionBase {
		...
		public PartitionBase(SPARQLQuery query) throws TimeOutException {
		...
		protected void computePartitions(SPARQLQuery query) throws TimeOutException {
		...
		protected int findDecrementable(int[] partition) {
